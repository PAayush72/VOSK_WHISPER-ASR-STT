...
```bash
git clone https://github.com/PAayush72/VOSK_WHISPER-ASR-STT.git
cd VOSK_WHISPER-ASR-STT
```
...
Build and run:
```bash
docker build -t vosk-whisper-asr-stt .
docker run --gpus all -p 8765:8765 vosk-whisper-asr-stt
```
